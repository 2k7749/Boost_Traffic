        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <form class="navbar-form navbar-left">
                    <input class="form-control" placeholder="Traffic Bot" style="width: 175px">
                </form>
        ...
        <nav>
            <ul class="nav luna-nav">
                ...
                <li class="nav-info">
                    ...
                    <div class="m-t-xs">
                        <span class="c-white">Traffic Bot -</span> <?php echo $version; ?>  a lot of future insert more description here bruh.
                    </div>
                </li>
            </ul>
        </nav>
